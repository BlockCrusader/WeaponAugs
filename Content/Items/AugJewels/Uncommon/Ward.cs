...
namespace WeaponAugs.Content.Items.AugJewels.Uncommon
{
	public class WardJewelUnc : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Ward") + Language.GetTextValue("Mods.WeaponAugs.Items.Uncommon");
	...
	public class WardJewelRar : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Ward") + Language.GetTextValue("Mods.WeaponAugs.Items.Rare");
	...
	public class WardJewelEpi : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Ward") + Language.GetTextValue("Mods.WeaponAugs.Items.Epic");
	...
	public class WardJewelUlt : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Ward") + Language.GetTextValue("Mods.WeaponAugs.Items.Ultimate");
