...
namespace WeaponAugs.Content.Items.AugJewels.Uncommon
{
	public class DiversionJewelUnc : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Diversion") + Language.GetTextValue("Mods.WeaponAugs.Items.Uncommon");
	...
	public class DiversionJewelRar : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Diversion") + Language.GetTextValue("Mods.WeaponAugs.Items.Rare");
	...
	public class DiversionJewelEpi : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Diversion") + Language.GetTextValue("Mods.WeaponAugs.Items.Epic");
	...
	public class DiversionJewelUlt : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Diversion") + Language.GetTextValue("Mods.WeaponAugs.Items.Ultimate");
