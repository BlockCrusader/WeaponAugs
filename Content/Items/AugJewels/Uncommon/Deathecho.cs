...
namespace WeaponAugs.Content.Items.AugJewels.Uncommon
{
	public class DeathechoJewelUnc : AugmentJewel
	{
		...
		private string AugTitle => "Deathecho (Uncommon)";
	...
	public class DeathechoJewelRar : AugmentJewel
	{
		...
		private string AugTitle => "Deathecho (Rare)";
	...
	public class DeathechoJewelEpi : AugmentJewel
	{
		...
		private string AugTitle => "Deathecho (Epic)";
	...
	public class DeathechoJewelUlt : AugmentJewel
	{
		...
		private string AugTitle => "Deathecho (Ultimate)";
