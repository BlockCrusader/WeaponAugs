...
namespace WeaponAugs.Content.Items.AugJewels.Basic
{
	public class RushJewelBas : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Rush") + Language.GetTextValue("Mods.WeaponAugs.Items.Basic");
	...
	public class RushJewelUnc : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Rush") + Language.GetTextValue("Mods.WeaponAugs.Items.Uncommon");
	...
	public class RushJewelRar : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Rush") + Language.GetTextValue("Mods.WeaponAugs.Items.Rare");
	...
	public class RushJewelEpi : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Rush") + Language.GetTextValue("Mods.WeaponAugs.Items.Epic");
	...
	public class RushJewelUlt : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Rush") + Language.GetTextValue("Mods.WeaponAugs.Items.Ultimate");
