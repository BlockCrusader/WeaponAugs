...
namespace WeaponAugs.Content.Items.AugJewels.Basic
{
	public class BallisticJewelBas : AugmentJewel
	{
		...
		private string AugTitle => "Ballistic (Basic)";
	...
	public class BallisticJewelUnc : AugmentJewel
	{
		...
		private string AugTitle => "Ballistic (Uncommon)";
	...
	public class BallisticJewelRar : AugmentJewel
	{
		...
		private string AugTitle => "Ballistic (Rare)";
	...
	public class BallisticJewelEpi : AugmentJewel
	{
		...
		private string AugTitle => "Ballistic (Epic)";
	...
	public class BallisticJewelUlt : AugmentJewel
	{
		...
		private string AugTitle => "Ballistic (Ultimate)";
