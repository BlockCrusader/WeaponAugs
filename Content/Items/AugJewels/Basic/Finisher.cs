...
namespace WeaponAugs.Content.Items.AugJewels.Basic
{
	public class FinisherJewelBas : AugmentJewel
	{
		...
		private string AugTitle => "Finisher (Basic)";
	...
	public class FinisherJewelUnc : AugmentJewel
	{
		...
		private string AugTitle => "Finisher (Uncommon)";
	...
	public class FinisherJewelRar : AugmentJewel
	{
		...
		private string AugTitle => "Finisher (Rare)";
	...
	public class FinisherJewelEpi : AugmentJewel
	{
		...
		private string AugTitle => "Finisher (Epic)";
	...
	public class FinisherJewelUlt : AugmentJewel
	{
		...
		private string AugTitle => "Finisher (Ultimate)";
