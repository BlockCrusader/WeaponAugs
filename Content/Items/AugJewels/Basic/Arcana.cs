...
namespace WeaponAugs.Content.Items.AugJewels.Basic
{
	public class ArcanaJewelBas : AugmentJewel
	{
		...
		private string AugTitle => "Arcana (Basic)";
	...
	public class ArcanaJewelUnc : AugmentJewel
	{
		...
		private string AugTitle => "Arcana (Uncommon)";
	...
	public class ArcanaJewelRar : AugmentJewel
	{
		...
		private string AugTitle => "Arcana (Rare)";
	...
	public class ArcanaJewelEpi : AugmentJewel
	{
		...
		private string AugTitle => "Arcana (Epic)";
	...
	public class ArcanaJewelUlt : AugmentJewel
	{
		...
		private string AugTitle => "Arcana (Ultimate)";
