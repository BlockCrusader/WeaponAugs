...
{
	// Each Augment Jewel class will contain all rarity variants
	public class MightJewelBas : AugmentJewel
	{
		// Augment type and tier applied
		public override AugType Augment => AugType.Might;
		public override AugTier Tier => AugTier.Basic;

		// Name of tooltip line that gets replaced
	...
	public class MightJewelUnc : AugmentJewel
	{
		public override AugType Augment => AugType.Might;
		...
		public override void SetDefaults()
		{
			Item.CloneDefaults(ModContent.ItemType<MightJewelBas>());
			Item.rare = ItemRarityID.Orange;
		}
	}

	public class MightJewelRar : AugmentJewel
	{
		public override AugType Augment => AugType.Might;
	...
	public class MightJewelEpi : AugmentJewel
	{
		public override AugType Augment => AugType.Might;
	...
	public class MightJewelUlt : AugmentJewel
	{
		public override AugType Augment => AugType.Might;
