...
namespace WeaponAugs.Content.Items.AugJewels.Basic
{
	public class CombobreakJewelBas : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Combobreak") + Language.GetTextValue("Mods.WeaponAugs.Items.Basic");
	...
	public class CombobreakJewelUnc : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Combobreak") + Language.GetTextValue("Mods.WeaponAugs.Items.Uncommon");
	...
	public class CombobreakJewelRar : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Combobreak") + Language.GetTextValue("Mods.WeaponAugs.Items.Rare");
	...
	public class CombobreakJewelEpi : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Combobreak") + Language.GetTextValue("Mods.WeaponAugs.Items.Epic");
	...
	public class CombobreakJewelUlt : AugmentJewel
	{
		...
		private string AugTitle => Language.GetTextValue("Mods.WeaponAugs.Items.Combobreak") + Language.GetTextValue("Mods.WeaponAugs.Items.Ultimate");
