...
{
	class OverflowProj : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            if (closestNPC != null)
            {
                ...
                float rotCur = base.Projectile.velocity.ToRotation();
                float rotMax = MathHelper.ToRadians(5f);
                Projectile.velocity = Projectile.velocity.RotatedBy(MathHelper.WrapAngle(MathHelper.WrapAngle(rotCur.AngleTowards(rotTarget, rotMax)) - Projectile.velocity.ToRotation()));
            }
        }
        ...
        public NPC FindClosestNPC(float maxDetectionDistance)
        {
            ...
            for (int i = 0; i < 200; i++)
            {
                ...
                if (target.CanBeChasedBy())
                {
                    ...
                    {
                        sqrDistanceToTarget *= 2f; // Makes targets out of line of sight much less likey to be targeted
                    }
