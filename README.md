# WeaponAugs
This is the GitHub repository for my tModLoader (Terraria) mod 'Weapon Augments', which introduces an upgrade system to the game that revolves around adding special effects to weapons.
